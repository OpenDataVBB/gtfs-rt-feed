...
const haveSameIfoptStationId = (stopIdA, stopIdB) => {
	const c = 3 // country, area, station
	return (
		stopIdA === stopIdB ||
		stopIdA.split(':').slice(0, c).join(':') === stopIdB.split(':').slice(0, c).join(':')
	)
}
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:12:23:34'), true)
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:12:23'), true)
strictEqual(haveSameIfoptStationId('de:12:23', 'de:12:23:34'), true)
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:12:23:45'), true)
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:00:23:34'), false)
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:00:23'), false)
strictEqual(haveSameIfoptStationId('de:12:23', 'de:00:23:34'), false)
strictEqual(haveSameIfoptStationId('de:12:23:34', 'de:00:23:45'), false)
	...
	const matchGtfsRtTripUpdateWithScheduleStopTimes = async (tripUpdate, opt = {}) => {
		...
		if (tripUpdateIsExhaustive && !tripUpdateIncludesServiceStops) {
			...
			if (
				...
				&& haveSameIfoptStationId(lastSTU.stop_id, secondLastSTU.stop_id)
			) {
